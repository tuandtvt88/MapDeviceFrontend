...
export function Tang2NCVso6() {
    ...
    useEffect(() => {
        fetch("https://backend-mapdevice.onrender.com/api/tang2ncvso6")
    ...
    const handleDelete = (id) => {
        ...
        if (confirmDelete) {
            fetch(`https://backend-mapdevice.onrender.com/api/tang2ncvso6/${id}`, {
                method: "DELETE",
            })
                .then(async (res) => {
                    if (!res.ok) {
    ...
    const handleSaveName = (wifiId) => {
        ...
        fetch(`https://backend-mapdevice.onrender.com/api/tang2ncvso6/${wifiId}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
