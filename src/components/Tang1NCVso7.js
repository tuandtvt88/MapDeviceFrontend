...
export function Tang1NCVso7() {
    ...
    useEffect(() => {
        fetch("https://backend-mapdevice.onrender.com/api/tang1ncvso7")
    ...
    const handleDelete = (id) => {
        ...
        if (confirmDelete) {
            fetch(`https://backend-mapdevice.onrender.com/api/tang1ncvso7/${id}`, {
                method: "DELETE",
            })
                .then(async (res) => {
                    if (!res.ok) {
    ...
    const handleSaveName = (wifiId) => {
        ...
        fetch(`https://backend-mapdevice.onrender.com/api/tang1ncvso7/${wifiId}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
    ...
    return (
        <div className="nhacongvu">
            <div className="map-container" onClick={handleMapClick}>
                <img src={image} alt="Tang 1 NCV so 5" className="map-image" />
                ...
                {/* Highlight circle for the searched WiFi */}
                {highlightedWifi && (
                    <div
                        className="wifi-highlight"
                        style={{
                            position: "absolute",
                            top: highlightedWifi.topPosition,
                            left: highlightedWifi.leftPosition,
                            width: "40px",
                            height: "40px",
                            borderRadius: "50%",
