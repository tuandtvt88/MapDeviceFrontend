...
export function Tang4Gamma() {
    ...
    useEffect(() => {
        ...
        fetch("https://backend-mapdevice.onrender.com/api/tang4gamma")
    ...
    const handleDelete = (id) => {
        ...
        if (confirmDelete) {
            fetch(`https://backend-mapdevice.onrender.com/api/tang4gamma/${id}`, {
                method: "DELETE",
            })
                .then(async (res) => {
                    if (!res.ok) {
    ...
    const handleSaveName = (wifiId) => {
        ...
        fetch(`https://backend-mapdevice.onrender.com/api/tang4gamma/${wifiId}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
