...
export function Tang3Beta() {
    ...
    useEffect(() => {
        ...
        fetch("https://backend-mapdevice.onrender.com/api/tang3beta")
    ...
    const handleDelete = (id) => {
        ...
        if (confirmDelete) {
            fetch(`https://backend-mapdevice.onrender.com/api/tang3beta/${id}`, {
                method: "DELETE",
            })
                .then(async (res) => {
                    if (!res.ok) {
    ...
    const handleSaveName = (wifiId) => {
        ...
        fetch(`https://backend-mapdevice.onrender.com/api/tang3beta/${wifiId}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
