...
export function Tang2Gamma() {
    ...
    useEffect(() => {
        ...
        fetch("https://backend-mapdevice.onrender.com/api/tang2gamma")
    ...
    const handleDelete = (id) => {
        ...
        if (confirmDelete) {
            fetch(`https://backend-mapdevice.onrender.com/api/tang2gamma/${id}`, {
                method: "DELETE",
            })
                .then(async (res) => {
                    if (!res.ok) {
    ...
    const handleSaveName = (wifiId) => {
        ...
        fetch(`https://backend-mapdevice.onrender.com/api/tang2gamma/${wifiId}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
