...
export function Tang1NCVso5() {
    ...
    useEffect(() => {
        fetch("https://backend-mapdevice.onrender.com/api/tang1ncvso5")
    ...
    const handleDelete = (id) => {
        ...
        if (confirmDelete) {
            fetch(`https://backend-mapdevice.onrender.com/api/tang1ncvso5/${id}`, {
                method: "DELETE",
            })
                .then(async (res) => {
                    if (!res.ok) {
    ...
    const handleSaveName = (wifiId) => {
        ...
        fetch(`https://backend-mapdevice.onrender.com/api/tang1ncvso5/${wifiId}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
