...
export function Vovinam() {
    ...
    useEffect(() => {
        ...
        fetch("https://backend-mapdevice.onrender.com/api/vovinam")
    ...
    const handleDelete = (id) => {
        ...
        if (confirmDelete) {
            fetch(`https://backend-mapdevice.onrender.com/api/vovinam/${id}`, {
                method: "DELETE",
            })
                .then(async (res) => {
                    if (!res.ok) {
    ...
    const handleSaveName = (wifiId) => {
        ...
        fetch(`https://backend-mapdevice.onrender.com/api/vovinam/${wifiId}`, {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
